...
function renderCart() {
    ...
    cartSummaryHtml += `
      ...
      matchingProduct.name
        ...
        <div class="item-actions">
          <button class="delete-btn js-delete-btn" data-product-id="${
            matchingProduct.id
          }">
  ...
  itemsContainer.innerHTML = cartSummaryHtml;
  plusMinusButtons();
  deleteButton();
  totalCostCalculate();
}
...
function totalCostCalculate() {
  ...
  if (!totalEl) return console.error(".total-amount element not found");
  ...
  subTotalEl.textContent = total.toLocaleString("fr-DZ") + " DA";
}
